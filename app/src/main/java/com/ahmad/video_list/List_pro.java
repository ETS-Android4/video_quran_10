...
public class List_pro extends Activity 
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
		...
		ArrayAdapter arrayAdapter = new ArrayAdapter<String>(this, R.layout.resource_ahmah, R.id.textresource, yousuf);
		...
		mohamad.setOnItemClickListener(new AdapterView.OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view,
					...
					if (amer == 0) {
						Intent ahmad = new Intent(List_pro.this, Main1Activity.class);
						startActivity(ahmad);
